...
while True:
    ...
    print('\n\tDate:',cur_date_t,'| Check Interval:',sleep_interval,'sec.\n')
    ...
    print('\t| ',"ONLINE",' - ping less than 500 msec.')
    print('\t| ',"FREZEE",' - ping more than 500 msec.')
    print('\t| ',"OFFLINE",'- ping more than 1500 ms.')
    print('\t|');
    print('\t|--------------------------------------\n');
    #Countdown timer
